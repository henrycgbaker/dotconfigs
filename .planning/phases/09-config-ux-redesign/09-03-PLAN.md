...
must_haves:
  truths:
    ...
    - "Git identity configs (CLAUDE_GIT_USER_NAME, CLAUDE_GIT_USER_EMAIL) NOT collected by Claude wizard — handled by git plugin (Plan 04)"
  artifacts:
  ...
  key_links:
    ...
    - from: "plugins/claude/setup.sh"
      to: "plugins/git/setup.sh"
      via: "Git identity responsibility moved to git plugin (Plan 04)"
      pattern: "CLAUDE_GIT_USER_NAME|CLAUDE_GIT_USER_EMAIL"
      assertion: "absent_from_wizard_flow"
---
