...
**Modify `deploy_from_json()` in lib/deploy.sh** to accept an optional `project_root` parameter. (This modification is backwards-compatible with Plan 11-02's usage -- project_root will be empty/omitted for global deploy.) When project_root is set:
