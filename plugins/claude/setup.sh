...
_claude_configure_behaviour() {
    ...
    # Settings.json
    echo "settings.json defines Claude Code's permission rules and guard hooks:"
    echo "  - Which files Claude can read/write"
    echo "  - Which commands are allowed or blocked"
    echo "  - PreToolUse guards (destructive commands, GitHub comment posts)"
    echo ""
    echo "It's merged into your ~/.claude/settings.json, preserving any"
    echo "permission grants Claude has added locally."
    echo "  Source: plugins/claude/settings.json"
    echo ""
